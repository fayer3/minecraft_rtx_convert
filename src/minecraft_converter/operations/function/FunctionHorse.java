...
public class FunctionHorse {
    ...
    public static String compute(FileAccess access, String source, Settings config) throws ExitNow {
        try {
            ...
            access.zipAddFileStream("ui/horse_screen.json", FunctionHorse.class.getClassLoader().getResourceAsStream("bedrock/horse_screen.json"));
